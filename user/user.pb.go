...
type GetAllAdminResp struct {
	...
	Admins map[string]int64 `protobuf:"bytes,1,rep,name=admins,proto3" json:"admins" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
}
...
func (x *GetAllAdminResp) GetAdmins() map[string]int64 {
	if x != nil {
		return x.Admins
	}
	return nil
